    ...
    for code in selected:
        ...
        try:
            ...
            sr = requests.get(
                ...
                headers={"User-Agent": "Mozilla/5.0 FootballValueLab/1.6.8",
...
def download_upcoming(selected):
    ...
    # Primary source: SofaScore daily schedule.
...
st.caption("V1.6.8 — 4 championnats • calendrier automatique • paper trading")
